...
interface Constants{
    public static final int TMAX = 29;
    public static final int SMAX = 25;
    public static final int CMAX = 6;
    public static final int LMAX = 8;
}
    ...
    public static void ClearTables(){
        ...
        for(ObCounter=0;ObCounter<Constants.TMAX;ObCounter++){
            for(Day=0;Day<5;Day++)
            {
                for(Period=0;Period<7;Period++)
                {
                    //System.out.println("Day:" + Day + "Period:" + Period + "ObCounter:" + ObCounter);
...
public class TimeTable{
    ...
    public static void main(String Input){
        ...
        //Input = "C:\\Documents and Settings\\Home\\Desktop\\TimeTableReRevised\\TimeTable\\Excel Input Files\\input file_ec_new_revised.xls";
