...
class TimeTableGen{
    ...
    public static Integer TotalUnalloted = 0;
    ...
    public static void ClassAllotment(){
        ...
        Integer TCounter,SCounter,CCounter,CurrentSubId,SubHrs,AltHrs,Day,Rnd,CurrentClassId,MaxDayTry,MaxSubTry,MaxWeekTry;
        ...
        for(TCounter=0;TCounter<Constants.TMAX;TCounter++){//To traverse through Teacher Objects
            ...
            for(SCounter=0;CurrentTeacher.SCId[SCounter][0]!=null;SCounter++){//To traverse through the Subjects of the Teacher
                ...
                for(CCounter=1;CCounter<5;CCounter++){//To traverse throught the Classes of the Teacher
                    ...
                    while((AltHrs<SubHrs)&&(MaxSubTry<5)){
                        ...
                        for(Day=0;(Day<5)&&(AltHrs<SubHrs)/*&&(MaxWeekTry<Constants.MAXTRY)*/;Day++){
                            
                            //System.out.println("Two");
                            MaxDayTry=0;
                            
                            while((Class[CurrentClassId].isDayFull(Day)==false)&&(MaxDayTry<100)){

                                if((Class[CurrentClassId].Alt[Day][Rnd]==null)&&(CurrentTeacher.ClsAlt[Day][Rnd]==null)&&(ConsecutiveCheck(CurrentClassId,Day,Rnd,CurrentSubId))&&(FirstPeriodCheck(CurrentClassId,CurrentSubId))){
    ...
    public static boolean ConsecutiveCheck(Integer ClassId, Integer Day, Integer Period, Integer CurrentSubId){
        
        if(Period!=1&&Period!=6){
            
            if(CurrentSubId==Class[ClassId].Alt[Day][Period+1])
                return false;
    ...
    public static boolean FirstPeriodCheck(Integer ClassId, Integer SubId){
        
        Integer Day;
        Integer Count=0;
        for(Day=0;Day<5;Day++){
            if(Class[ClassId].Alt[Day][0]==SubId)
                Count++;
        }
...
public class TimeTable{
    public static void main(String args[]){
        ...
        do{
            ...
            System.out.println("No of unallotted periods in Generation " + Generation + ": " + TimeTableGen.TotalUnalloted);
            Generation++;
        }while(TimeTableGen.TotalUnalloted>0);
        
        System.out.println("TimeTable of Generation " + (Generation-1));
