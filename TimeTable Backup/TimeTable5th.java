...
class TimeTableGen{
                    ...
                    while((AltHrs<SubHrs)&&(MaxSubTry<5)){
                        ...
                        for(Day=0;(Day<5)&&(AltHrs<SubHrs)/*&&(MaxWeekTry<Constants.MAXTRY)*/;Day++){
                            ...
                            while((Class[CurrentClassId].isDayFull(Day)==false)&&(MaxDayTry<100)){
                                ...
                                if((Class[CurrentClassId].Alt[Day][Rnd]==null)&&(CurrentTeacher.ClsAlt[Day][Rnd]==null)&&(ConsecutiveCheck(CurrentClassId,Day,Rnd,CurrentSubId))){
    ...
    public static void Unassigned(){
        Integer CCounter,NoUnassigned,Day,Period;
        for(CCounter=0;CCounter<Constants.CMAX;CCounter++){
